    ...
    <div className={"container-fluid mx-auto px-4 sm:px-20 p-4  grid grid-cols-[20%_minmax(20%,_1fr)]  justify-between items-center border-b-[1px] border-[#ffffff3b] header   " + (router.pathname ? router.pathname.replace('/','') : '')}>
      ...
      <div className="flex items-end justify-end">
        ...
        <ul className=" flex justify-between items-center gap-4 text-sm text-white">
          ...
          <li className="bg-[#d5cc65] text-black p-3 transition delay-[3000ms] duration-300 ease-in-out  font-semibold rounded-2xl 	hover:bg-[#222222] hover:text-[#fff]">
            ...
            <SheetContent>
              <SheetHeader>
                ...
                <ul className="text-sm text-black text-left mt-6">
                  ...
                  <li className="mb-4 pb-1 border-b-[1px] border-[#d0d0d0]">
                    <Link href="/faq">{t(footerLanguage["menu-item-3"])}</Link>
                  </li>
